...
5. Setup MetaSim reinforcement learning environments.
    ...
    MetaSim provides two reinforcement learning demos: [PPO Reaching](advanced/rl_example/0_ppo.md) and [FastTD3 Humanoid](advanced/rl_example/1_fttd3.md). To run these two demos, please follow the steps below to setup your environments.
