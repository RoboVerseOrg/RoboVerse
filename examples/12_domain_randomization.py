...
Run:
    python examples/12_domain_randomization.py --scene_mode 0 --level 2
"""
...
def run_replay(env, randomizers, init_state, all_actions, args):
    ...
    video_path = f"examples/output/12_dr_mode{args.scene_mode}_{mode_names[args.scene_mode]}_level{args.level}.mp4"
