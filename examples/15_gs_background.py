...
if __name__ == "__main__":
    ...
    # save rgb image
    save_path = f"examples/output/15_gs_background_{args.sim}.jpg"
    ...
    # save depth image
    save_path = f"examples/output/15_gs_background_{args.sim}_depth.jpg"
    ...
    obs_saver = ObsSaver(video_path=f"examples/output/15_gs_background_360_{args.sim}.mp4")
    ...
    log.info(f"Video saved to examples/output/15_gs_background_{args.sim}.mp4")
