...
class Args:
    ...
    headless: bool = True
    dataset_path: str = "examples/output/bimanual_handover_v2.pkl"
...
def main():
    ...
    obs_saver = None
    if args.save_video:
        video_path = f"examples/output/8_multiagent_dataset_{args.sim}.mp4"
    ...
    if obs_saver is not None:
        obs_saver.save()
        log.info(f"Video saved to examples/output/8_multiagent_dataset_{args.sim}.mp4")
