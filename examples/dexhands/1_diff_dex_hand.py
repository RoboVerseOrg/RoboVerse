...
def main():
    ...
    os.makedirs("examples/output/dexhands", exist_ok=True)
    obs_saver = ObsSaver(video_path=f"examples/output/dexhands/1_diff_dex_hand_{args.sim}_{args.robot}.mp4")
    ...
    obs_saver.save()
    log.info(f"Video saved to: examples/output/dexhands/1_diff_dex_hand_{args.sim}_{args.robot}.mp4")
