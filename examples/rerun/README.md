...
python examples/rerun/replay_task_demo.py --task stack_cube --sim mujoco --spawn-viewer --output stack_cube.rrd
...
python examples/rerun/rerun_demo.py --sim mujoco

# Using PyBullet simulator
python examples/rerun/rerun_demo.py --sim pybullet
```
...
python examples/rerun/rerun_demo.py --sim mujoco --dynamic
...
python examples/rerun/rerun_demo.py --sim mujoco --dynamic --save-recording my_session.rrd
...
python examples/rerun/save_trajectory_simple.py --sim mujoco --spawn-viewer
