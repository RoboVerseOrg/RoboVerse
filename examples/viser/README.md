...
### Basic Static Scene
```bash
python examples/viser/viser_demo.py --sim pybullet
```
...
```bash
python examples/viser/viser_demo.py --sim pybullet --enable-joint-control
```

### 3. Interactive IK Control
Control end-effector position/orientation:
```bash
python examples/viser/viser_demo.py --sim pybullet --enable-ik-control
```

### 4. Trajectory Playback
Load and play recorded trajectories:
```bash
python examples/viser/viser_demo.py --sim pybullet --enable-trajectory \
...
```bash
python examples/viser/viser_demo.py --sim pybullet --dynamic
```

With video recording:
```bash
python examples/viser/viser_demo.py --sim pybullet --dynamic --save-video
```
...
python examples/viser/viser_demo.py
```

### Interactive Control
```bash
# Joint control with different simulator
python examples/viser/viser_demo.py --sim genesis --enable-joint-control

# IK control with different robot
python examples/viser/viser_demo.py --robot ur5e --enable-ik-control
```

### Trajectory Playback
```bash
# Load and play trajectory
python examples/viser/viser_demo.py --enable-trajectory \
...
python examples/viser/viser_demo.py --dynamic --save-video
```
