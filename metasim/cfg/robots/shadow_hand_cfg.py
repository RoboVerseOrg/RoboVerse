...
class ShadowHandCfg(BaseRobotCfg):
    ...
    actuators: dict[str, BaseActuatorCfg] = {
        ...
        "robot0_FFJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_FFJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_FFJ0": BaseActuatorCfg(stiffness=1.0, fully_actuated=False),
        "robot0_MFJ3": BaseActuatorCfg(stiffness=1.0),
        "robot0_MFJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_MFJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_MFJ0": BaseActuatorCfg(stiffness=1.0, fully_actuated=False),
        "robot0_RFJ3": BaseActuatorCfg(stiffness=1.0),
        "robot0_RFJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_RFJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_RFJ0": BaseActuatorCfg(stiffness=1.0, fully_actuated=False),
        "robot0_LFJ4": BaseActuatorCfg(stiffness=1.0),
        "robot0_LFJ3": BaseActuatorCfg(stiffness=1.0),
        "robot0_LFJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_LFJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_LFJ0": BaseActuatorCfg(stiffness=1.0, fully_actuated=False),
        "robot0_THJ4": BaseActuatorCfg(stiffness=1.0),
        "robot0_THJ3": BaseActuatorCfg(stiffness=1.0),
        "robot0_THJ2": BaseActuatorCfg(stiffness=1.0),
        "robot0_THJ1": BaseActuatorCfg(stiffness=1.0),
        "robot0_THJ0": BaseActuatorCfg(stiffness=1.0),
    }
