...
to vary the look (HDRI image-based lighting, solid background colour, sun
key light, ground plane with simple PBR material).

All functions operate on the currently active scene via ``bpy.context``;
they assume a Blender backend session is already running.
"""
