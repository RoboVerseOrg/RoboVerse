...
# RUN git clone --depth 1 --branch main git@github.com:RoboVerseOrg/MetaSim.git ${HOME}/MetaSim
## Option 2: Copy necessary files for building conda environment
COPY --chown=${DOCKER_USER} ./metasim ${HOME}/MetaSim/metasim
COPY --chown=${DOCKER_USER} ./LICENSE ${HOME}/MetaSim/LICENSE
COPY --chown=${DOCKER_USER} ./README.md ${HOME}/MetaSim/README.md
COPY --chown=${DOCKER_USER} ./pyproject.toml ${HOME}/MetaSim/pyproject.toml

WORKDIR ${HOME}/MetaSim
