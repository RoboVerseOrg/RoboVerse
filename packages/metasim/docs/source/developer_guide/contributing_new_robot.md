...
<!-- The definition of each term is explained in [API Documentation](/metasim/api/metasim/metasim.scenario.robot#baserobotcfg). -->
...
Add the robot to the [RoboVerse data repository](https://huggingface.co/datasets/RoboVerseOrg/roboverse_data) by creating a PR. Please follow the [repository structure](https://huggingface.co/datasets/RoboVerseOrg/roboverse_data/tree/main). We thank you for your contribution.
...
- To change joint names in USD, open the asset in the Isaac Sim or Isaac Lab GUI, find the joint item in the USD tree, and rename it by double-clicking the joint name.
