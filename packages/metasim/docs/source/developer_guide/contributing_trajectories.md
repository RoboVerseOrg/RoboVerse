...
The recorded trajectories should be saved in the v2 trajectory format, which is a dumped dict defined in [State](../concept/state.md#trajectory).
...
Add the trajectories to the [RoboVerse data repository](https://huggingface.co/datasets/RoboVerseOrg/roboverse_data) by creating a PR. Please follow the [repository structure](https://huggingface.co/datasets/RoboVerseOrg/roboverse_data/tree/main). We thank you for your contribution.
