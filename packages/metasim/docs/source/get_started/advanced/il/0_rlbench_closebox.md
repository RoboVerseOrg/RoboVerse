...
See [Collect Demo](../../quick_start/7_collect_demo.md) for more details about collecting demonstrations and the available command options.
    ...
    <div style="display: flex; justify-content: space-between; width: 100%; margin-bottom: 20px;">
        <div style="width: 48%; text-align: center;">
            <video width="100%" autoplay loop muted playsinline>
                <source src="/metasim/_static/standard_output/il/0_closebox.mp4" type="video/mp4">
            </video>
