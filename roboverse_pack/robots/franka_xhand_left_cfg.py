...
@configclass
class FrankaXHandLeftCfg(BaseDexCfg):
    """Cfg for the franka with left xhand robot."""

    name: str = "franka_xhand_left"
    num_joints: int = 19
    num_arm_joints: int = 7
    fix_base_link: bool = True
    usd_path: str = "roboverse_data/robots/franka_xhand/usd/franka_xhand_left.usd"
    project_root: Path = Path(__file__).resolve().parents[2]
    hand_urdf_path: Path = (
        project_root / "roboverse_data" / "robots" / "franka_xhand" / "urdf" / "xhand_left.urdf"
    )
    ...
    fingertips = ["left_hand_index_rota_tip", "left_hand_mid_tip", "left_hand_ring_tip", "left_hand_pinky_tip", "left_hand_thumb_rota_tip"]
    fingertips_offset = [0.0, 0.0, 0.0]
    ee_base_link = "panda_link7"
    wrist = "left_hand_link"
    palm = "left_hand_ee_link"
    ...
    actuators: dict[str, BaseActuatorCfg] = {
        "left_hand_index_bend_joint": BaseActuatorCfg(),
        "left_hand_index_joint1": BaseActuatorCfg(),
        "left_hand_index_joint2": BaseActuatorCfg(),
        "left_hand_mid_joint1": BaseActuatorCfg(),
        "left_hand_mid_joint2": BaseActuatorCfg(),
        "left_hand_pinky_joint1": BaseActuatorCfg(),
        "left_hand_pinky_joint2": BaseActuatorCfg(),
        "left_hand_ring_joint1": BaseActuatorCfg(),
        "left_hand_ring_joint2": BaseActuatorCfg(),
        "left_hand_thumb_bend_joint": BaseActuatorCfg(),
        "left_hand_thumb_rota_joint1": BaseActuatorCfg(),
        "left_hand_thumb_rota_joint2": BaseActuatorCfg(),
    ...
    joint_limits: dict[str, tuple[float, float]] = {
        "left_hand_index_bend_joint": (-0.174, 0.174),
        "left_hand_index_joint1": (0, 1.919),
        "left_hand_index_joint2": (0, 1.919),
        "left_hand_mid_joint1": (0, 1.919),
        "left_hand_mid_joint2": (0, 1.919),
        "left_hand_pinky_joint1": (0, 1.919),
        "left_hand_pinky_joint2": (0, 1.919),
        "left_hand_ring_joint1": (0, 1.919),
        "left_hand_ring_joint2": (0, 1.919),
        "left_hand_thumb_bend_joint": (0, 1.832),
        "left_hand_thumb_rota_joint1": (-0.698, 1.57),
        "left_hand_thumb_rota_joint2": (0, 1.571),
    ...
    def load_robot_for_ik(self):
        raise NotImplementedError("IK solver loading not implemented for Franka XHand left.")

    def control_hand_ik(self, target_pos, target_rot):
        raise NotImplementedError("Hand IK control not implemented for Franka XHand left.")
