...
class VegaCfg(RobotCfg):
    ...
    joint_limits: dict[str, tuple[float, float]] = {
        ...
        "L_th_j0": (0.693886, 0.693886),
        "L_th_j1": (0.049071, 0.149071),
        "L_th_j2": (0.001562, 0.201562),
        # Left hand - Fingers locked to initial grasp pose
        "L_ff_j1": (-0.751686, -0.551686),
        "L_ff_j2": (-0.821416, -0.621416),
        "L_mf_j1": (-0.551840, -0.551840),
        "L_mf_j2": (-0.625254, -0.625254),
        "L_rf_j1": (0.014122, 0.014122),
        "L_rf_j2": (0.015942, 0.015942),
        "L_lf_j1": (0.023751, 0.023751),
        "L_lf_j2": (0.027291, 0.027291),
