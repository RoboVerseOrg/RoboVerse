...
class PandaPickCube(panda.PandaBase):
    ...
    def __init__(
        ...
        xml_path = mjx_env.ROOT_PATH / "manipulation" / "franka_emika_panda" / "xmls" / "mjx_single_cube.xml"
        super().__init__(
            xml_path,
            config,
            config_overrides,
    ...
    def _get_reward(self, data: mjx.Data, info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        hand_floor_collision = [
            data.sensordata[self._mj_model.sensor_adr[sensor_id]] > 0 for sensor_id in self._floor_hand_found_sensor
        ]
