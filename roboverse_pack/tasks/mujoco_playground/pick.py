...
class PandaPickCube(RLTaskEnv):
    ...
    def _reward_gripper_box(self, env_states) -> torch.Tensor:
        ...
        finger1_target = 0.035
        finger2_target = 0.035
        finger1_reward = 1.0 - torch.abs(finger1_pos - finger1_target) / finger1_target  # [num_envs]
        finger2_reward = 1.0 - torch.abs(finger2_pos - finger2_target) / finger2_target  # [num_envs]
