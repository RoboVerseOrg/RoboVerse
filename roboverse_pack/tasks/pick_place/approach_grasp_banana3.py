...
@register_task(
    "pick_place.approach_grasp_simple_banana3",
    "pick_place.approach_grasp_simple_banana3",
    "pick_place.approach_grasp_banana3",
)
class PickPlaceApproachGraspSimpleBanana3(PickPlaceApproachGraspSimple):
            ...
            init = [
                {
                    "objects": {
                        ...
                        "bowl": {
                            "pos": torch.tensor([0.140000, -0.090000, 0.863000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "object": {
                            "pos": torch.tensor([0.240000, -0.630000, 0.825000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "mug": {
                            "pos": torch.tensor([0.540000, -0.710000, 0.863000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "book": {
                            "pos": torch.tensor([0.620000, -0.120000, 0.820000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "remote_control": {
                            "pos": torch.tensor([0.320000, -0.340000, 0.811000]),
                            "rot": torch.tensor([0.911038, 0.000000, -0.000000, 0.412321]),
                        },
                        "vase": {
                            "pos": torch.tensor([0.300000, 0.050000, 0.950000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "traj_marker_0": {
                            "pos": torch.tensor([0.220000, -0.630000, 0.870000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "traj_marker_1": {
                            "pos": torch.tensor([0.270000, -0.560000, 0.900000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "traj_marker_2": {
                            "pos": torch.tensor([0.360000, -0.470000, 0.920000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "traj_marker_3": {
                            "pos": torch.tensor([0.420000, -0.390000, 0.900000]),
                            "rot": torch.tensor([0.601833, 0.798621, 0.000000, -0.000000]),
                        },
                        "traj_marker_4": {
                            "pos": torch.tensor([0.450000, -0.310000, 0.850000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                    },
                    "robots": {
                        "franka": {
                            ...
                            "rot": torch.tensor([0.519098, -0.000000, -0.000001, 0.854714]),
                            "dof_pos": {
