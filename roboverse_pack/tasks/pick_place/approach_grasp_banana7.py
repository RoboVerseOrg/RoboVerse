...
@register_task(
    "pick_place.approach_grasp_simple_banana7",
    "pick_place.approach_grasp_simple_banana7",
    "pick_place.approach_grasp_banana7",
)
class PickPlaceApproachGraspSimpleBanana7(PickPlaceApproachGraspSimple):
            ...
            init = [
                {
                    "objects": {
                        ...
                        "object": {
                            "pos": torch.tensor([0.550000, -0.510000, 0.825000]),
                            "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                        },
                        "traj_marker_0": {
