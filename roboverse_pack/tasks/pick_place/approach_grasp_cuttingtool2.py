...
@register_task(
    ...
    "pick_place.approach_grasp_simple_cuttingtool2",
    "pick_place.approach_grasp_cuttingtool2",
)
class PickPlaceApproachGraspSimpleCuttingTool2(PickPlaceApproachGraspSimple):
    ...
    - Initial states: Loads poses from saved_poses_20251206_cuttingtool2_basket.py
    """
    ...
    def _get_initial_states(self) -> list[dict] | None:
        ...
        saved_poses = {
            "objects": {
                ...
                "basket": {
                    "pos": torch.tensor([0.530000, 0.180000, 0.825000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "object": {
                    "pos": torch.tensor([0.570000, -0.330000, 0.820000]),
                    "rot": torch.tensor([0.930507, 0.000000, -0.000000, 0.366273]),
                },
                "spoon": {
                    "pos": torch.tensor([0.220000, -0.020000, 0.850000]),
                    "rot": torch.tensor([0.961352, -0.120799, 0.030845, 0.245473]),
                },
                "mug": {
                    "pos": torch.tensor([0.500000, -0.710000, 0.863000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "book": {
                    "pos": torch.tensor([0.220000, -0.520000, 0.820000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "remote_control": {
                    "pos": torch.tensor([0.260000, -0.270000, 0.811000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "traj_marker_0": {
                    "pos": torch.tensor([0.510000, -0.290000, 0.830000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "traj_marker_1": {
                    "pos": torch.tensor([0.480000, -0.340000, 0.900000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "traj_marker_2": {
                    "pos": torch.tensor([0.360000, -0.410000, 0.930000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
                "traj_marker_3": {
                    "pos": torch.tensor([0.250000, -0.470000, 0.930000]),
                    "rot": torch.tensor([0.601833, 0.798621, 0.000000, -0.000000]),
                },
                "traj_marker_4": {
                    "pos": torch.tensor([0.230000, -0.520000, 0.890000]),
                    "rot": torch.tensor([1.000000, 0.000000, 0.000000, 0.000000]),
                },
            },
            "robots": {
