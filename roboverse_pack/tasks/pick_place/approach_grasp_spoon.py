...
class PickPlaceApproachGraspSimpleSpoon(PickPlaceApproachGraspSimple):
    ...
    def _get_initial_states(self) -> list[dict] | None:
        """Hardcoded initial states from saved_poses_20251212_spoon.py."""
        saved_poses = {
            "objects": {
                "table": {
        ...
        for _ in range(self.num_envs):
            env_state = {
                "objects": {
                    ...
                    "mug": saved_poses["objects"]["mug"],
                    "book": saved_poses["objects"]["book"],
                    "vase": saved_poses["objects"]["vase"],
...
class PickPlaceApproachGraspSimpleSpoon2(PickPlaceApproachGraspSimpleSpoon):
    ...
    def _get_initial_states(self) -> list[dict] | None:
        """Hardcoded initial states from saved_poses_20251212_spoon2.py."""
        saved_poses = {
            "objects": {
                "table": {
                    "pos": torch.tensor([0.440000, -0.200000, 0.400000]),
