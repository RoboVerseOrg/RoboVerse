...
@register_task("approach_grasp_hand_relative", "approachgrasphandrelative")
class ApproachGraspHandRelative(TrajectoryTrackingTaskBase):
    """Simple Approach and Grasp task with hand control using relative pose alignment.

    This task focuses on:
    - Approaching the object with relative pose alignment
    - Grasping the object with saved finger positions when close
    ...
    def reset(self, env_ids=None):
        ...
        self._is_close_enough[env_ids_tensor] = False
    ...
    def step(self, actions):
        ...
        # Check if close enough to use saved finger positions (based on relative pose error)
        self._is_close_enough = relative_pos_error < self.APPROACH_DISTANCE_THRESHOLD
