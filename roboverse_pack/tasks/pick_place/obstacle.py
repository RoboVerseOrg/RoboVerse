"""Pick up a box and navigate over a wall obstacle."""
...
from .base import TrajectoryTrackingTaskBase


@register_task("pick_place.obstacle", "pick_place_obstacle")
class PickPlaceObstacle(TrajectoryTrackingTaskBase):
