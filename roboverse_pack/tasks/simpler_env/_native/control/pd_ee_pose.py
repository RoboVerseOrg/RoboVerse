...
# Changes: from `mani_skill2_real2sim/agents/controllers/pd_ee_pose.py`; import paths rewritten for RoboVerse
#   (unused `BaseController` import dropped) and line wrapping reflowed by the repo formatter; controller math
#   unchanged (AST-identical to upstream, kept byte-faithful for bitwise parity).
