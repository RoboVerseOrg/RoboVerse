...
# mujoco isaacsim
for task in kitchen_scene1_put_the_black_bowl_on_top_of_the_cabinet; do
    python scripts/advanced/collect_demo.py --sim=mujoco --task=libero_90.$task --num_envs=1 --headless # --render.mode pathtracing  --cust_name new_render_256_pathtracing_0
done
